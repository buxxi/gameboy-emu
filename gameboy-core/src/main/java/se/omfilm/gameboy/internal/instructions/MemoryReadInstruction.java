...
/**
 * Instructions that reads from memory should do that in the last machine cycle (the last 4 clock cycles)
 * Make those instructions declare the totalCycles that it uses so the padding can be calculated.
 */
public interface MemoryReadInstruction extends Instruction {
    /**
